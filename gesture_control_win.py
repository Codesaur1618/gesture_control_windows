...
class HandRecog:
    ...
    def get_gesture(self):
        ...
        if self.finger == Gest.PALM:  # Open palm gesture
            current_gesture = Gest.PALM
...
class Controller:
    ...
    def changesystemvolume(cls):
        devices = AudioUtilities.GetSpeakers()
        IID_IAudioEndpointVolume = IID("{5CDF2C82-841E-4546-9722-0CF74078229A}")  # Manually specify the IID
    ...
    def handle_controls(gesture, hand_result):
        ...
        if gesture == Gest.LEFT_HAND_LOCK:
            os.system("rundll32.exe user32.dll,LockWorkStation")
        if gesture == Gest.SCREENSHOT:
